...
5. **Read First**: Review exports, callers, utilities before editing. Ambiguity → write ADR in `.agents/docs/ADRs/`. Blocked → follow [workflow rules](../rules/workflow.md#unresolvable-blockers).
