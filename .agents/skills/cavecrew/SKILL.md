---
name: cavecrew
description: Delegate to caveman-style subagents (investigator, builder, reviewer) to compress output by ~60% and save context tokens
when_to_use: delegating tasks, spawning subagents, saving context, or running compressed agent workflows.
metadata:
  category: workflow
---
# Cavecrew
