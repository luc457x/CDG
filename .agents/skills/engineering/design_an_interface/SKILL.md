---
name: design_an_interface
description: Generate multiple radically different interface designs for module using parallel sub-agents. Use when user wants to design API, explore interface options, compare module shapes, or mentions "design it twice".
---
...
For interface design during **architecture deepening** (refactoring shallow modules into deep ones), see [INTERFACE_DESIGN.md](../improve_codebase_architecture/INTERFACE_DESIGN.md) — same base pattern, extended with seam/adapter/leverage vocabulary from [LANGUAGE.md](../improve_codebase_architecture/LANGUAGE.md).
