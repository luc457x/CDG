---
name: request_refactor_plan
description: Create detailed refactor plan with tiny commits via user interview, then file as GitHub issue. Use when user wants to plan refactor, create refactoring RFC, or break refactor into safe incremental steps.
---
