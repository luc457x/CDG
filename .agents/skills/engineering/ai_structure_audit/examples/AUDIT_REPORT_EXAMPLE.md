...
| `HARNESS.md` | 2.3 KB | 🔶 Partial |
| `TASKS.md` | 1.8 KB | ✅ Instantiated |
...
| **Skills** | Modular, composable, with examples | Lack precision for deterministic execution |
...
**Problem:** WORKFLOW.md defines only happy path.
