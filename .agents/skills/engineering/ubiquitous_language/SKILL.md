...
description: Extract DDD ubiquitous language glossary from conversation, flagging ambiguities and saving to UBIQUITOUS_LANGUAGE.md. Use when user wants to define domain terms, build glossary, or mentions "domain model" or "DDD".
---
