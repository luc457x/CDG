---
name: audit_skills
description: Audit agent skills folder for structural correctness, line length constraints, and link validity. Use when checking skills structure, validation of skills folder, or running skill audit.
---
...
```bash
python .agents/skills/engineering/audit_skills/scripts/audit_skills.py --output [artifact_directory]/skills_audit_report.md
```

Audit single skill:

```bash
python .agents/skills/engineering/audit_skills/scripts/audit_skills.py --skill [skill_name] --output [artifact_directory]/skills_audit_report.md
```
...
- **Description format**: description under 1024 chars, must include trigger sentence starting "Use when...".
