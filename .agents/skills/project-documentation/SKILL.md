...
1. **Header Navigation Bar**:
   - Do **NOT** use Markdown tables for sidebars. Headings (`#`, `##`, `###`) nested inside table cells do not render properly and cause line-break layout bugs.
...
2. **Relative Links Formatting**:
   ...
   - For links inside same folder, write filename directly (e.g. `architecture.md` instead of `./architecture.md`).
