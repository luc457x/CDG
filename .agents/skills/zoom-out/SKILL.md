---
name: zoom-out
description: Disciplined protocol to map high-level codebase architecture, trace component boundaries, and establish mental models of unfamiliar modules
when_to_use: getting lost in low-level details, onboarding to new subsystem, or when explicitly asked to "zoom out".
metadata:
  category: analysis
---
# Zoom Out
