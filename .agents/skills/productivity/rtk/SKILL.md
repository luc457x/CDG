---
name: rtk
description: Utilizes 'rtk' tool for terminal output and token optimization. Use when wrapping terminal commands, reducing token volume, or running commands via rtk.
---
