---
name: ai-structure-audit
description: Systematic audit of .agents/ AI engineering structure for consistency, completeness, and prompt quality
when_to_use: checking agent engineering structure, validating directory format, or running structure audit.
metadata:
...
11. **[Overengineering Check](./reference/AUDIT_CHECKLIST.md#11-overengineering-check)**: Check file-to-scope and skill-to-scope ratios. Classify overengineering state.
