---
name: context-aware-init
description: Stack-aware repository initialization and repair protocol
when_to_use: initializing repository, setting up folder structure, or repairing stack configuration.
metadata:
  category: setup
---
...
4. **Verification & Commit**:
   ...
   - Commit changes following `atomic-commit` guidelines.
