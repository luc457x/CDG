...
- State: Implementing Alpha plan; Phases 01–29 implemented.
- Last: Hardened optimization rf fallback, simulation cap, + 0.01 bias doc, path-injection test, confirmed coingecko sleep and menu concurrency/annualization already done.
